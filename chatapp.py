...
class senderwindow:
    def __init__(self,master):
        ...
        techniquebutton = (
            tk.Button(middle_frame, text="Encrypt", font=BUTTON_FONT, bg=OCEAN_BLUE, fg=WHITE, ))
    ...
    def open(self, ciphertextbook):
        ...
        techniquebutton1 = (
            tk.Button(middle_frame1, text="Decrypt", font=BUTTON_FONT, bg=OCEAN_BLUE, fg=WHITE, ))
